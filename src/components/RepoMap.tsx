...
const EN: Copy = {
  ...
  n: {
    ...
    n2mesh: { label: 'Meshcore', sub: 'WebRTC · MQTT · serverless' },
    ...
    aurora: { label: 'Aurora', sub: 'TypeScript · zero deps' },
    cyber: { label: 'CyberForge', sub: 'Rust · pcap · OpenSSL' },
...
const PL: Copy = {
  ...
  n: {
    hub: { label: 'Docs Hub', sub: 'Docusaurus · GitHub Pages' },
    rnd: { label: 'R&D', sub: 'Quantum Flash Tomograph · Zenodo' },
    n2mesh: { label: 'Meshcore', sub: 'WebRTC · MQTT · bez serwera' },
    link: { label: 'LinkShort', sub: 'FastAPI · React 19 · SQLite' },
    nova: { label: 'Novactorio', sub: 'TypeScript · Canvas 2D · Supabase' },
    nv2: { label: 'NV2 Engine', sub: 'Rust · wgpu · MLP' },
    aurora: { label: 'Aurora', sub: 'TypeScript · zero zależności' },
    cyber: { label: 'CyberForge', sub: 'Rust · pcap · OpenSSL' },
    talus: { label: 'Talus Monitor', sub: 'Rust · eBPF · Aya' },
