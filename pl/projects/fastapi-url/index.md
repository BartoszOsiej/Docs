...
- [Pierwsze kroki](getting-started) — lokalna konfiguracja i pierwsze uruchomienie
- [Referencja API](api-reference) — każdy endpoint z żądaniami i odpowiedziami
- [Wdrożenie](deployment) — Docker, środowiska, uwagi produkcyjne
