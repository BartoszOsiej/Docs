...
- [Architektura](architecture) — silnik, renderer, świat, warstwy UI
- [Systemy gry](gameplay) — łańcuchy dostaw, taśmy, rury, wrogowie, zanieczyszczenie
- [Backend i monetyzacja](backend) — Supabase, Stripe, edge functions
