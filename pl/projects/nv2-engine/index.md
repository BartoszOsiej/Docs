...
| Strona | Zawartość |
|---|---|
| [Architektura](architecture) | Pełny runtime, renderer, świat, warstwy UI — moduł po module |
| [Rozgrywka](gameplay) | Sterowanie, interakcja, inventory, crafting, komendy, trwałość |
| [Bloki i biomy](blocks) | Kompletny rejestr 97 bloków, poziomy narzędzi, 9 definicji biomów, rudy |
| [Referencja craftingu](crafting) | Każdy przepis z dokładnymi wzorami |
| [Symulacja wody](water) | Kodowanie cieczy, solver i wewnętrzne renderowania |
| [System roślinności AI](ai) | Matematyka sieci, pętla treningu, hiperparametry, integracja |
| [Wydajność](performance) | Przepustowość GPU, culling, budżety meshowania, profile |
| [Rozwój](development) | Build, mapa modułów, testowanie, rozszerzanie silnika |
| [Plan i zmiany](roadmap) | Historia, plany Faz 2, znane ograniczenia |
