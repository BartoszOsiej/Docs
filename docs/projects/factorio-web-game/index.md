...
- [Architecture](/projects/factorio-web-game/architecture) — engine, renderer, world, UI layering
- [Gameplay Systems](/projects/factorio-web-game/gameplay) — supply chains, belts, pipes, enemies, pollution
- [Backend & Monetization](/projects/factorio-web-game/backend) — Supabase, Stripe, edge functions
