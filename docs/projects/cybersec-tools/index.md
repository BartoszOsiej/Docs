...
|---|---|---|
| [NetRecon](/projects/cybersec-tools/netrecon) | Concurrent TCP port scanner | CIDR expansion, hostname resolution, banner grabbing, JSON output, worker pool |
| [ShadowScan](/projects/cybersec-tools/shadowscan) | Web vulnerability scanner | Security header audit, TLS/cert inspection, reflected XSS/SQLi probes, path discovery |
| [HashSleuth](/projects/cybersec-tools/hashsleuth) | Hash identification & cracking | Fingerprinting of 15+ formats, parallel dictionary attack, masked brute force |
| [PacketEye](/projects/cybersec-tools/packeteye) | pcap traffic analyzer | Live + offline capture, protocol mix, top talkers, TCP handshake stats |
