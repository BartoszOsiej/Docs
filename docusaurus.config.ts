      ...
      items: [
        { type: 'doc', docId: 'projects/index', position: 'left', label: 'Projects' },
        {
          ...
          items: [
            ...
            { type: 'doc', docId: 'projects/cybersec-tools/index', label: 'CyberForge' },
            { type: 'doc', docId: 'projects/aurora-os/index', label: 'Aurora' },
            ...
            { type: 'doc', docId: 'projects/n2-mesh/index', label: 'Meshcore' },
          ],
        },
        ...
        {
          href: 'https://bartoszosiej.github.io/Promptbox/',
          position: 'left',
          label: 'Promptbox',
        },
        {
      ...
      links: [
        {
          ...
          items: [
            ...
            { label: 'CyberForge', to: '/projects/cybersec-tools/' },
          ],
        },
        {
          title: 'More',
          items: [
            { label: 'Aurora', to: '/projects/aurora-os/' },
            { label: 'Externum', to: '/projects/externum/' },
            { label: 'Meshcore (P2P Chat)', to: '/projects/n2-mesh/' },
            { label: 'PDF Book & Translator', to: '/translator' },
            { label: 'Promptbox', href: 'https://bartoszosiej.github.io/Promptbox/' },
          ],
        },
        {
          title: 'Community',
